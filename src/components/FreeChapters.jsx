...
export function FreeChapters() {
  return (
    <section
      ...
      className="scroll-mt-14 bg-primer sm:scroll-mt-32"
    >
        ...
        >
          ...
          <div>
            <h2 className="font-display text-5xl font-extrabold tracking-tight text-white sm:w-3/4 sm:text-6xl md:w-2/3 lg:w-auto">
              Dapatkan katalog secara gratis
            </h2>
            <p className="mt-4 text-lg tracking-tight text-stone-700">
              Masukan email anda untuk mendapatkan pembaruan katalog dari kami.
            </p>
          </div>
          <form className="lg:pl-16">
            <h3 className="text-base font-medium tracking-tight text-white">
              Update katalog setiap satu minggu{' '}
            ...
            <div className="mt-4 sm:relative sm:flex sm:items-center sm:py-0.5 sm:pr-2.5">
              <div className="relative sm:static sm:flex-auto">
                ...
                />
                <div className="absolute inset-0 rounded-md border border-white/20 peer-focus:border-stone-300 peer-focus:bg-stone-500 peer-focus:ring-1 peer-focus:ring-stone-300 sm:rounded-xl" />
              </div>
              <Button
                type="submit"
                color="white"
