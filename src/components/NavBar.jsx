...
const sections = [
  {
    ...
    title: (
      <>
        ...
        <span className="lg:hidden">Benefit</span>
      </>
    ),
  },
  { id: 'screencasts', title: 'Promo Spesial' },
  { id: 'resources', title: 'Kenapa Boutique?' },
  { id: 'pricing', title: 'Berlangganan' },
  { id: 'author', title: 'Pelanggan Baru' },
]
              ...
              <a
                ...
                className={clsx(
                  ...
                  sectionIndex === activeIndex
                    ? 'border-stone-600 bg-stone-50 text-stone-600 before:text-stone-600'
                    : 'border-transparent before:text-slate-500 hover:bg-stone-50/40 hover:before:text-slate-900',
                )}
              >
                {section.title}
              </a>
