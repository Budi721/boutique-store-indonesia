...
const videos = [
  {
    title: 'Cari Kebutuhan Anda',
    description:
      'Temukan produk batik yang sesuai dengan gaya dan kebutuhan Anda di Boutique.id.',
    image: setupImage,
  ...
  },
  {
    ...
    description:
      'Setelah menemukan produk yang Anda sukai, tambahkan ke keranjang belanja dengan satu klik saja. ',
    image: gridsImage,
  ...
  },
  {
    ...
    description:
      'Setelah berhasil melakukan pembayaran, Anda tinggal menunggu produk pesanan Anda dikirimkan.',
    image: strokesImage,
    runtime: { minutes: 23, seconds: 25 },
  },
  {
    title: 'Berikan Rating dan Feedback',
    description:
      'Setelah menerima produk Anda, berikanlah rating dan feedback mengenai pengalaman belanja Anda di Boutique.id.',
    image: duotoneImage,
    ...
    >
      <Container>
        ...
        <p className="mt-4 text-lg tracking-tight text-slate-700">
          ...
          Nikmati juga gratis ongkir untuk setiap pembelian di atas Rp500.000.
        </p>
        <p className="mt-4 text-lg tracking-tight text-slate-700">
          Tunggu apa lagi? Segera temukan koleksi batik impian Anda hanya di Boutique.id.
        </p>
      </Container>
